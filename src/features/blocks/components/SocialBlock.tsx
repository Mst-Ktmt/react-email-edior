import type { SocialBlockProps, SocialPlatform } from '@/types/block';
...
export function SocialBlock({ props, isSelected, onClick }: Props) {
  const { links, iconSize, iconColor, gap, align, padding } = props;
